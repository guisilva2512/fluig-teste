...
function callService(fields, constraints, sortFields) {
	...
	// criando usuario pelo formulario avaliar candidato
	// a variavel contrainst será a mesma que esta recebendo da consulta do dataset

	for (var i in constraints) {
		// fiedlName é o primeiro item na criação da constraint
		// finalValue é o valor final desta constraint
		if (constraints[i]["fieldName"] == "colleagueId") {
			// vou substituir o que esta setado no input values do params, pelo que esta no formulario
			// que esta sendo passado pela contrainst
	...
	return {
		...
		"inputValues": {
			...
			"colleagues": [{
				"active": true,
				"adminUser": false,
				"colleagueId": "guilherme.silva",
				"colleagueName": "Guilherme Silva",
				"companyId": 1,
				"login": "guilherme.silva",
				"mail": "guisilva@gmail.com",
				"passwd": "guilherme.silva"
			}],
